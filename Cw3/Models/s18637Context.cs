...
{
    public partial class s18637Context : DbContext
    {
        public s18637Context()
        {
        }

        public s18637Context(DbContextOptions<s18637Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=db-mssql;Initial Catalog=s18637;Integrated Security=True");
            }
        }
